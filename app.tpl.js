angular.module('app.tpl', ['calendar.tpl.html', 'archive.tpl.html', 'about.tpl.html', 'help.tpl.html', 'list_item.tpl.html', 'kalender.tpl.html', 'focus.tpl.html', 'modal.delete.tpl.html', 'modal.focus.distraction_list_confirmation.tpl.html', 'modal.edit_task_name.tpl.html', 'modal.focus.stop_timer.tpl.html', 'modal.later.tpl.html', 'modal.pick_parent_task.tpl.html', 'modal.pick_endtime.tpl.html', 'modal.pick_latertime.tpl.html', 'modal.pick_postponetime.tpl.html', 'modal.pick_remindertime.tpl.html', 'modal.pick_repeattime.tpl.html', 'modal.pick_starttime.tpl.html', 'modal.pick_starttimeperiod.tpl.html', 'modal.plan.tpl.html', 'modal.postpone.tpl.html', 'modal.timer.tpl.html', 'statistics.tpl.html', 'settings.tpl.html', 'organize.tpl.html', 'todo.tpl.html', 'help/exit.tpl.html', 'help/calendar.tpl.html', 'help/archive.tpl.html', 'help/about.tpl.html', 'help/help.tpl.html', 'help/focus.tpl.html', 'help/settings.tpl.html', 'help/statistics.tpl.html', 'help/organize.tpl.html', 'help/todo.tpl.html', 'help/settings/popups.tpl.html', 'help/settings/plan.tpl.html', 'help/settings/sdone.tpl.html', 'help/settings/slong.tpl.html', 'help/settings/sfocus.tpl.html', 'help/settings/settings.tpl.html', 'help/settings/sshort.tpl.html', 'help/settings/weeks.tpl.html', 'help/settings/slope.tpl.html', 'help/plan/ereminder.tpl.html', 'help/plan/duration.tpl.html', 'help/plan/exact.tpl.html', 'help/plan/period.tpl.html', 'help/plan/preminder.tpl.html', 'help/plan/eremove.tpl.html', 'help/plan/premove.tpl.html', 'help/plan/type.tpl.html', 'help/plan/priority.tpl.html', 'help/plan/repeat.tpl.html', 'help/settings/clean.tpl.html', 'help/settings/ball.tpl.html', 'help/settings/nav.tpl.html']);
...
angular.module("list_item.tpl.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("list_item.tpl.html",
        ...
        "            <span ng-bind=\"(task.timeType==='exact'&&task.planned?'('+priorityLabel(task)+')'+(task.repeated&&$parent.organize?' [uppr.]':'')+':':'')+task.title\"></span>\n" +
        "          </span>\n" +
        "\n" +
...
angular.module("organize.tpl.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("organize.tpl.html",
        ...
        "    <div class=\"sort\">\n" +
        "      <div>sortera</div>\n" +
        "      <label><select ng-init=\"$parent.sorting = '+startTime'\" ng-model=\"$parent.sorting\">\n" +
